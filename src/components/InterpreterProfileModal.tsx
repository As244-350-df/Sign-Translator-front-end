...
interface InterpreterProfileModalProps {
  interpreter: Interpreter | null;
  isOpen: boolean;
  onClose: () => void;
  onStartCall: (interpreterId: string) => void;
  onBookSlot: (interpreter: Interpreter, slot: string) => void;
  settings: AppSettings;
}

export const InterpreterProfileModal: React.FC<InterpreterProfileModalProps> = ({
  interpreter,
  isOpen,
  onClose,
  onStartCall,
        ...
        <div className="p-6 sm:p-8 pt-0 relative">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-16 mb-6">
            <div className="relative">
              ...
              />
              <span className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full ring-4 ring-white dark:ring-slate-900 ${
          ...
          <div className="my-6">
            ...
            <div className="space-y-1.5">
              {interpreter.certifications.map((cert, idx) => (
                <div 
                  key={idx}
          ...
          <div className="my-6">
            ...
            <div className="flex flex-wrap gap-1.5">
              {interpreter.specialties.map((spec, i) => (
                <span
                  key={i}
