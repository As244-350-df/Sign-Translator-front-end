              ...
              {isInIframe && tracking.inputSourceMode === "webcam" && (
                <div className="flex items-center justify-between px-3.5 py-2.5 rounded-2xl bg-amber-950/70 border border-amber-500/50 text-amber-200 text-xs shadow-md animate-in fade-in">
                  ...
                  <div className="flex items-center space-x-2 shrink-0">
                    ...
                    <button
                      onClick={() => tracking.handleSelectInputMode("simulator")}
                      className="px-2.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs flex items-center space-x-1 transition-colors cursor-pointer shadow-xs"
                    >
