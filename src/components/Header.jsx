...
const Header = ({
  ...
  return <header className={`sticky top-0 z-40 border-b transition-colors duration-200 ${settings.darkTheme ? "bg-slate-900/95 border-slate-800 text-white backdrop-blur-md" : "bg-white/95 border-slate-200 text-slate-900 backdrop-blur-md"}`}>
    ...
    /* Logo & Brand */
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => onChangeTab("translate")}>
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-cyan-500 text-white shadow-lg shadow-indigo-500/25">
              ...
              {isCallActive && <span className="absolute -top-1 -right-1 flex h-3 w-3">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full font-semibold ${isInterpreter ? "bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300" : "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300"}`}>
    ...
    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center space-x-1.5 ${activeTab === "translate" ? "bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 shadow-xs" : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"}`}
  >
    ...
    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center space-x-1.5 ${activeTab === "keyboard" ? "bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 shadow-xs" : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"}`}
  >
    ...
    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center space-x-1.5 ${activeTab === "directory" ? "bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 shadow-xs" : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"}`}
  >
              <Video className="w-4 h-4" />
              <span>Interpreters</span>
            </button>

            {isInterpreter ? <button
    onClick={() => onChangeTab("interpreter_dashboard")}
    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center space-x-1.5 ${activeTab === "interpreter_dashboard" ? "bg-purple-50 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300 shadow-xs" : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"}`}
  >
                <Briefcase className="w-4 h-4" />
                <span>My Dashboard</span>
              </button> : <button
    onClick={() => onChangeTab("schedule")}
    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center space-x-1.5 ${activeTab === "schedule" ? "bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 shadow-xs" : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"}`}
  >
    ...
    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "history" ? "bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 shadow-xs" : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"}`}
  >
              Vault & History
            </button>
  ...
  >
              ...
              {unreadCount > 0 && <span className="absolute top-1.5 right-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-rose-500 text-[10px] font-bold text-white">
                  {unreadCount}
                </span>}
            </button>
