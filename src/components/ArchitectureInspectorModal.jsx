...
const ArchitectureInspectorModal = ({
  isOpen,
  onClose
}) => {
  ...
  >
    ...
    className={`pb-3 px-3 text-xs font-bold whitespace-nowrap border-b-2 transition-all ${activeTab === "diagram" ? "border-indigo-600 text-indigo-600 dark:border-indigo-400 dark:text-indigo-400" : "border-transparent text-slate-500 hover:text-slate-800 dark:hover:text-slate-200"}`}
  >
            System Flow
          </button>
          <button
    onClick={() => setActiveTab("firestore-erd")}
    className={`pb-3 px-3 text-xs font-bold whitespace-nowrap border-b-2 transition-all flex items-center space-x-1.5 ${activeTab === "firestore-erd" ? "border-indigo-600 text-indigo-600 dark:border-indigo-400 dark:text-indigo-400" : "border-transparent text-slate-500 hover:text-slate-800 dark:hover:text-slate-200"}`}
  >
    ...
    className={`pb-3 px-3 text-xs font-bold whitespace-nowrap border-b-2 transition-all ${activeTab === "components" ? "border-indigo-600 text-indigo-600 dark:border-indigo-400 dark:text-indigo-400" : "border-transparent text-slate-500 hover:text-slate-800 dark:hover:text-slate-200"}`}
  >
            Subsystem Specifications
          </button>
          <button
    onClick={() => setActiveTab("apis")}
    className={`pb-3 px-3 text-xs font-bold whitespace-nowrap border-b-2 transition-all ${activeTab === "apis" ? "border-indigo-600 text-indigo-600 dark:border-indigo-400 dark:text-indigo-400" : "border-transparent text-slate-500 hover:text-slate-800 dark:hover:text-slate-200"}`}
  >
    ...
    /* Tab: Firestore Database ERD & Schema */
        ...
        {activeTab === "firestore-erd" && <div className="space-y-6">
    ...
    /* Tab 1: Interactive System Architecture Diagram */
        ...
        {activeTab === "diagram" && <div className="space-y-6">
    ...
    /* Tab 3: Live REST & WebRTC Endpoints */
        ...
        {activeTab === "apis" && <div className="space-y-3">
            {[
  ...
  ].map((ep, idx) => <div key={idx} className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center justify-between font-mono text-xs">
                <div className="flex items-center space-x-3">
                  <span className={`px-2 py-0.5 rounded-md font-bold text-[10px] ${ep.method.includes("POST") ? "bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300" : "bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300"}`}>
                    {ep.method}
                  </span>
