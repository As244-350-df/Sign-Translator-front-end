...
import { Download, Play, CheckCircle2, Video, Clock, HardDrive, ShieldCheck, X } from 'lucide-react';
import { RecordedVideoResult, LiveSessionRecorder } from '../utils/mediaRecorder';

interface RecordedVideoModalProps {
  recording: RecordedVideoResult | null;
  onClose: () => void;
}

export const RecordedVideoModal: React.FC<RecordedVideoModalProps> = ({ recording, onClose }) => {
