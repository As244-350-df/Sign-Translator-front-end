    ...
    <div className="p-4 bg-slate-950 border-t border-slate-800 flex items-center justify-between flex-wrap gap-3">
      ...
      <div className="flex items-center space-x-2 sm:space-x-3 mx-auto">
        ...
        <button
          ...
          className={`flex items-center space-x-1.5 px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-2xl transition-all shadow-md cursor-pointer active:scale-95 ${
            isMuted
        ...
        <button
          ...
          className={`p-2.5 sm:p-3 rounded-2xl transition-all shadow-md cursor-pointer active:scale-95 ${
            isHandRaised
        ...
        <button
          onClick={onEndCall}
          className="px-4 sm:px-5 py-2.5 sm:py-3 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs flex items-center space-x-2 shadow-lg shadow-rose-600/40 transition-all active:scale-95 cursor-pointer ring-1 ring-rose-500"
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center space-x-2 border cursor-pointer relative ${
            showChat
