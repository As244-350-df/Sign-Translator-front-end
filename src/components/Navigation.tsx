...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const navItems = [
    ...
    isInterpreter 
      ? { id: 'interpreter_dashboard', label: 'Dashboard', icon: Briefcase }
  ...
  return (
    <div className={`md:hidden fixed bottom-0 left-0 right-0 z-40 border-t transition-colors duration-200 ${
      settings.darkTheme
